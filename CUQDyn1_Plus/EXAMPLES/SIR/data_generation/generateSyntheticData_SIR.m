%% generateSyntheticData_SIR.m
% Generate a synthetic SIR CSV in EXAMPLES/SIR/data.
%
...
ode_opts = odeset('RelTol', 1e-8, 'AbsTol', 1e-8);
...
if make_plots
    plot_synthetic_data(T, Y_true, Y_data, is_observed, 'SIR');
end
