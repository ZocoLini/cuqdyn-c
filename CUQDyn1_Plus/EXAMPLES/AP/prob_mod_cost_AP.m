function [J,g,R]=prob_mod_cost_AP(x,texp,yexp, observed_idx, dynamics_func_handle, initial_values_all_states, ode_opts, cost_opts)
...
% --- Simulate the FULL model (all 5 states) ---
