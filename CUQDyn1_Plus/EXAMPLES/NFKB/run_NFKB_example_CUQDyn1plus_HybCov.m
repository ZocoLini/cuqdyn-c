...
CUQDyn_results = CUQDyn1_Plus_HybridCov(cost_handle, dynamics_handle, nstates, n_params, guess_params, lb_params, ub_params, alp, times, all_state_data, initial_values_all_states, observed_data, observed_idx, resultDir, meigo_opts);
