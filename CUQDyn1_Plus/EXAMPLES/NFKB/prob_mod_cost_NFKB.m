function [J,g,R]=prob_mod_cost_NFKB(x,texp,yexp, observed_idx, dynamics_func_handle, initial_values_all_states, ode_opts, cost_opts)
...
% --- Simulate the FULL model (all 15 states) ---
...
[~,yout] = feval(ode_solver,dynamics_func_handle,texp,initial_values_all_states,options,x);

% --- Select ONLY the observed states from the simulation output ---
yout_observed = yout(:, observed_idx);
