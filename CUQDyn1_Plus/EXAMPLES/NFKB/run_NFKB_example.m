%% run_NFKB_example - legacy diagnostic NFKB runner
% LEGACY/DIAGNOSTIC ONLY.
%
% This script is retained for reproducing older NFKB runs that used a near-true
% initial guess, fmincon local refinement, and more verbose MEIGO output. It is
% intentionally excluded from run_all_examples.m.
%
% Maintained entry points for routine use:
...
guess_params = true_parameters*0.999;
...
opts.uq.alp = alp;
opts.meigo.maxeval = 1e4;
opts.meigo.local.solver = 'fmincon';
