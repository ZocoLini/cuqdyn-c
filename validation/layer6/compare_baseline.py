...
def main():
    ...
    ap.add_argument(
        "--matlab-dir", default=None, help="default: validation/layer6/matlab/<model>"
    )
    ap.add_argument(
        "--c-dir", default=None, help="default: validation/layer6/c/<model>"
    )
    args = ap.parse_args()

    # Both sides of layer 5 live next to this script, one directory per side.
    # The true trajectory and the time grid are not layer-6 material: they
