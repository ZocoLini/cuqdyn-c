function run_pipeline_cvodes(settings_file, base_seed, out_dir)
%RUN_PIPELINE_CVODES The MATLAB pipeline of layer 5: MEIGO + CVODES, seeded per launch.
%
%   run_pipeline_cvodes('<out>/layer5/lv2/settings.txt', 20260917, '<out>/layer5/lv2/matlab')
%
...
pb = layer5_problem(settings_file);
model = pb.name;
