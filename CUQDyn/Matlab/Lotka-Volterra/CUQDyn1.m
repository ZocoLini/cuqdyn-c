%% CUQDyn1 with MEIGO for Lotka-Volterra
...
% Store the results
resultFileName = sprintf('result_CUQDyn1_lv_noise_%.2f_size_%d_k_%d_alpha_%.2f.mat', ns, sz, ks, cf);
