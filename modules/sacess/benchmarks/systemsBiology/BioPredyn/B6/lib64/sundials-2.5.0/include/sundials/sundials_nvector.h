 ...
 *
 * N_VSpace
 *   Returns space requirements for one N_Vector (type 'sunrealtype' in
 ...
 *   as a contiguous 'sunrealtype' array. This routine is only used in
