...
typedef int (*IDAQuadRhsFn)(sunrealtype tres,
...
SUNDIALS_EXPORT int IDAQuadSStolerances(void *ida_mem, sunrealtype reltolQ, sunrealtype abstolQ);
SUNDIALS_EXPORT int IDAQuadSVtolerances(void *ida_mem, sunrealtype reltolQ, N_Vector abstolQ);
 ...
 * -----------------------------------------------------------------
 */
SUNDIALS_EXPORT int IDASensSStolerances(void *ida_mem, sunrealtype reltolS, sunrealtype *abstolS);
SUNDIALS_EXPORT int IDASensSVtolerances(void *ida_mem, sunrealtype reltolS, N_Vector *abstolS);
...
SUNDIALS_EXPORT int IDAQuadSensSStolerances(void *ida_mem, sunrealtype reltolQS, sunrealtype *abstolQS);
SUNDIALS_EXPORT int IDAQuadSensSVtolerances(void *ida_mem, sunrealtype reltolQS, N_Vector *abstolQS);
...
SUNDIALS_EXPORT int IDAGetQuadDky(void *ida_mem, sunrealtype t, int k, N_Vector dky);
/*
 * -----------------------------------------------------------------
...
SUNDIALS_EXPORT int IDAGetSens1(void *ida_mem, sunrealtype *tret, int is, N_Vector yySret);

SUNDIALS_EXPORT int IDAGetSensDky(void *ida_mem, sunrealtype t, int k, N_Vector *dkyS);
SUNDIALS_EXPORT int IDAGetSensDky1(void *ida_mem, sunrealtype t, int k, int is, N_Vector dkyS);
...
SUNDIALS_EXPORT int IDAGetQuadSens(void *ida_mem, sunrealtype *tret, N_Vector *yyQSout);
SUNDIALS_EXPORT int IDAGetQuadSens1(void *ida_mem, sunrealtype *tret, int is, N_Vector yyQSret);

SUNDIALS_EXPORT int IDAGetQuadSensDky(void *ida_mem, sunrealtype t, int k, N_Vector *dkyQS);
SUNDIALS_EXPORT int IDAGetQuadSensDky1(void *ida_mem, sunrealtype t, int k, int is, N_Vector dkyQS);
