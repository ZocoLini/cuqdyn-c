...
/// Bands and covariance from one parameter covariance variety.
typedef struct
{
...
typedef struct
{
    ...
    /// Rank-aware FIM covariance.
    UqBands fim;
    /// FIM marginal scale with the correlation of the leave-one-out ensemble.
    UqBands hybrid;
    N_Vector times;
