...
void lotka_volterra_ess(char *conf_file)
{
    ...
    N_Vector texp = New_Serial(32);
    for (int i = 0; i < NV_LENGTH_S(texp); ++i)
    {
        NV_Ith_S(texp, i) = i;
    }

    SUNMatrix yexp = NewDenseMatrix(30, 2);

    sunrealtype yexp_data[30][2] = {
...
void alpha_pinene_ess(char *conf_file)
{
    ...
    SUNMatrix yexp = NewDenseMatrix(9, 5);

    sunrealtype yexp_data[9][5] = {{1.409e-01, 3.034e-02, 1.409e-01, 3.034e-02, 3.252e-02},
...
void logistic_model_ess(char *conf_file)
{
    ...
    SUNMatrix yexp = NewDenseMatrix(11, 1);

    sunrealtype yexp_data[11][1] = {{1.000e+01}, {2.226e+01}, {6.066e+01}, {7.327e+01}, {9.123e+01}, {8.895e+01},
